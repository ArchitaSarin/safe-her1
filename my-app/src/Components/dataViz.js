        ...
        <div>
            ...
            <div id="lead-stats">
                ...
                <div id="lead-stats-1" class="lead-stat-box">
                    ...
                    <p class="lead-stat-text" id="lead-stat-one-text">Women as sexually assaulted in college</p>
            ...
            <div id="graph-section-1">
                ...
                <div id="graph-section-1-graph-container">
                    ...
                    <div class="graph-section-1-graph">
                        ...
                        <p class="graph-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat</p>
                    </div>
            ...
            <div id="graph-section-3">
                    ...
                    <div id="graph-section-3-content">
                        ...
                        <p class="graph-description" id="graph-2-desc"> The Graph above shows the how Intimate partner violence affects women around the world in the last 12 months among 7 areas. As we can observed that the average ratio in Sub-Saharan Africa is the highest, around 20%. And the average ration in Europe& Central Asia and North America are almost the same, and both of them are almost the lowest around 4%.</p>
